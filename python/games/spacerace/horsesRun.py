...
def problemHorse():
    ...
    if player == 1 and play01 == True and x01 > 0:
        ...
        if randint(0, maxRand) < state03 * 5:
            ...
            messagebox.showinfo("Аааа!",
                                f"{dartName} темной силой сводит с ума {jesuName}а.\n{jesuName} разворачивается")
        ...
        if randint(0, maxRand) < state04 * 5:
            ...
            messagebox.showinfo("Аааа!",
                                f'{gandName} применяет заклинание "Страх" на {dartName}а.\n{dartName} в страхе разворачивается')
...
def moveHorse():
    ...
    print(
        f"Гендальф X: {int(x01 * 100) / 100}, Sp :{int(speed01 * 100) / 100}, Рик X: {int(x02 * 100) / 100}, Sp :{int(speed02 * 100) / 100}, Иисус X: {int(x03 * 100) / 100}, Sp :{int(speed03 * 100) / 100}, Дарт X: {int(x04 * 100) / 100}, Sp :{int(speed04 * 100) / 100}")
